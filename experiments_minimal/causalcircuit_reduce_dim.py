...
from ws_crl_minimal.encoder import ImageEncoder, ImageDecoder, CoordConv2d
...
from ws_crl_minimal.utils import get_first_batch
...
@hydra.main(config_path="../config_minimal", config_name="causalcircuit_reduce_dim")
def main(cfg):
